...
import { CURSOR_PRIORITY_MODELS, CURSOR_KNOWN_MODELS, KNOWN_CURSOR_MODEL_IDS, cursorModelHint, } from "../../core/cursor-models.js";
import { loadProviders, saveProvider } from "../store.js";
import { PROXY_DEFAULT_URL, bundledComposerProxyShellCommand, fetchLiveCursorModels, resolveCursorAgentToken, getClaudeOvernightInstallRoot, resolveCursorComposerCli, } from "./env.js";
...
export async function pickCursorModel() {
    ...
    if (!healthy && !(await ensureCursorProxyRunning()) && !(await recoverCursorProxy()))
        return null;
...
async function recoverCursorProxy() {
