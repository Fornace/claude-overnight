...
const BAR_W = 30;
function fillBar(pct, filledColor, capMark = -1) {
...
export function UsageBars({ swarm, selectedAgentId }) {
    const rows = [];
    ...
    const renderRL = (pct, windowLabel) => {
...
export function SteeringBars({ rl }) {
    const rows = [];
