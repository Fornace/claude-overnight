...
export function buildUserPrompt(kind, scenario) {
    switch (kind) {
        case "planning":
...
function buildPlanningUserPrompt(s) {
...
function buildSimpleSupervisionUserPrompt(s) {
    const ctx = s.terminalContext;
    return `Current state: ${ctx.state}\n\nRecent terminal output:\n${ctx.recentOutput}\n\nProject goal: ${ctx.projectGoal}`;
}
function buildStuckAnalysisUserPrompt(s) {
...
export const SUPERVISION_SCENARIOS = [
    {
...
export function scenariosToCases(kind, scenarios) {
...
export function hydrateCases(cases) {
