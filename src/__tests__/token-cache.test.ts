...
import {
  ...
  tryRefreshCachedToken, clearTokenCache,
  revokeSession, clearRevocations, getRevocationCount,
  type TokenRecord, type JWTPayload,
} from "../core/token-cache.js";

const TEST_PROVIDER = "test-provider";
const SESSION_ID = "abc123";

function makePayload(expSecFromNow: number): JWTPayload {
...
function makeRecord(expSecFromNow: number): TokenRecord {
